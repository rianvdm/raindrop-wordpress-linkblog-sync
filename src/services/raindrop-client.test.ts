...
describe('RaindropClient', () => {
  ...
  describe('fetchBookmarks', () => {
    ...
    it('should handle 401 authentication error', async () => {
      ...
      await expect(client.fetchBookmarks('blog')).rejects.toThrow(RaindropError);
      await expect(client.fetchBookmarks('blog')).rejects.toThrow('Unauthorized');
    });
    ...
    it('should handle 500 server error', async () => {
      ...
      await expect(client.fetchBookmarks('blog')).rejects.toThrow(RaindropError);
      await expect(client.fetchBookmarks('blog')).rejects.toThrow('Internal Server Error');
    });
    ...
    it('should handle unsuccessful result', async () => {
      ...
      await expect(client.fetchBookmarks('blog')).rejects.toThrow('unsuccessful result');
    });
    ...
    it('should handle invalid response structure', async () => {
      ...
      await expect(client.fetchBookmarks('blog')).rejects.toThrow('items is not an array');
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(client.fetchBookmarks('blog')).rejects.toThrow('Failed to fetch bookmarks: Network failure');
    });
